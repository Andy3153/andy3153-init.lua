...
local options =
{
  ...
  guifont        = "IosevkaTerm NF:h12",            -- Font used by GUI Nvim interfaces (ex. Neovide)
...
opt.sessionoptions:append({ 'blank', 'buffers', 'curdir', 'folds', 'help', 'tabpages', 'winsize', 'winpos', 'terminal', 'localoptions' }) -- For auto-session
-- }}}
